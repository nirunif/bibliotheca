<%@ Page Title="Publisher Management" Language="C#" MasterPageFile="~/BibliothecaMasterPage.Master" AutoEventWireup="true" CodeBehind="ManagePublisher.aspx.cs" Inherits="Bibliotheca.ManagePublisher" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox ID="txtPubID" runat="server" CssClass="form-control" placeholder="ID"></asp:TextBox>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtPubName" runat="server" CssClass="form-control" placeholder="Name"></asp:TextBox>
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:GridView ID="dgvPublisherdetails" runat="server" class="table table-striped table-bordered"></asp:GridView>
                            </div>
                        </div>
